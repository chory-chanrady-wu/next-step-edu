    ...
    if (!user) {
        return (
            <div className="p-12 text-center">
                <h1 className="text-2xl font-bold text-gray-900 font-outfit">Member Not Found</h1>
                <p className="text-gray-500 mt-2">The user profile you are trying to access does not exist or has been removed.</p>
            </div>
        );
    }
