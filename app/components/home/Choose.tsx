...
const features = [
  {
    ...
    description:
      "Find universities and scholarships easily with powerful search and filter options.",
  },
  {
    icon: BookOpen,
    title: "Detailed Information",
    description:
      "Get complete details about programs, tuition fees, requirements, and more.",
  },
  {
    icon: Users,
    title: "Student-Focused",
    description:
      "Designed with students in mind to simplify your educational journey.",
  },
  {
    icon: Shield,
    title: "Verified Data",
    description:
      "All information is verified and regularly updated for accuracy.",
  },
  {
    icon: Clock,
    title: "Save Time",
    description:
      "Compare multiple options quickly and make informed decisions faster.",
  },
  {
    icon: Award,
    title: "Free to Use",
    description: "Access all features completely free of charge, forever.",
  },
];
      ...
      <Container>
        ...
        >
          ...
          <p className="mt-4 text-slate-600">
            We provide everything you need to make the right choice for your
