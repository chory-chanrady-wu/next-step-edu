...
const mapUniversity = (u: any) => ({
  id: u.id,
  name: u.name,
  coverImageUrl: u.coverImageUrl || "/images/placeholder-cover.jpg",
  logoUrl: u.logoUrl || "/images/placeholder-logo.png",
  shortDescription: u.shortDescription || u.description || "",
  city: u.city || "",
...
export default function FeaturedUniversities() {
  ...
  const featured = universities.slice(0, 3).map(mapUniversity);
