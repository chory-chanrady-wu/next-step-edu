        ...
        <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <Link href={`/admin/universities/${university.id}/edit`}>
                        <Button variant="outline" className="rounded-xl h-10 gap-2 border-gray-200 hover:bg-amber-50 hover:text-amber-600 hover:border-amber-200 transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    { icon: BookOpen, label: "Degree Programs", value: "86 Majors", color: "purple" },
                    { icon: Users, label: "Enrolled Students", value: "12.4k", color: "emerald" },
                    { icon: Star, label: "Global Ranking", value: "#42", color: "amber" }
                ].map((stat, i) => (
                    <Card key={i} className="border-none shadow-[0_4px_20px_rgb(0,0,0,0.02)] bg-white rounded-3xl">
                        <CardContent className="p-6 flex items-center gap-4 border-none">
                            ...
                            <div>
                                ...
                                <p className="text-lg font-black text-gray-900 font-outfit leading-none">{stat.value}</p>
                            </div>
                        </CardContent>
                    </Card>
                ))}
                ...
                <div className="space-y-8">
                    <Card className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white rounded-3xl overflow-hidden">
                        <div className="p-6 border-b border-gray-50 bg-gray-50/20">
                            <h2 className="text-lg font-bold text-gray-900 font-outfit">Quick Facts</h2>
                        </div>
                        <CardContent className="p-6 space-y-4 border-none">
                            {[
                                ...
                                <div key={i} className="flex items-center justify-between py-2 border-b border-gray-50 last:border-0">
                                    ...
                                    <span className="text-sm font-black text-gray-900 font-outfit">{fact.value}</span>
                                </div>
                            ))}
                        </CardContent>
                    </Card>
