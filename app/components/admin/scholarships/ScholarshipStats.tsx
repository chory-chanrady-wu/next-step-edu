...
export const ScholarshipStats: React.FC<ScholarshipStatsProps> = ({
  ...
  return (
    <div className={`flex flex-col rounded gap-2 ${className}`}>
      <span className='text-sm font-medium text-gray-700 dark:text-gray-300'>Scholarship Statistics</span>
      <div className='w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4'>
        ...
        <div className="box-total-scholarship rounded-xl border dark:border-gray-700 p-4 flex items-center gap-4 bg-white dark:bg-gray-800 hover:shadow-sm transition-shadow">
          ...
          <div className="box-info">
            ...
            <div className="box-label text-sm text-gray-600/80 dark:text-gray-400">Total Applications</div>
          </div>
        </div>
        ...
        <div className="box-total-scholarship rounded-xl border dark:border-gray-700 p-4 flex items-center gap-4 bg-white dark:bg-gray-800 hover:shadow-sm transition-shadow">
          ...
          <div className="box-info">
            ...
            <div className="box-label text-sm text-gray-600/80 dark:text-gray-400">Shortlisted</div>
          </div>
        </div>
        ...
        <div className="box-total-scholarship rounded-xl border dark:border-gray-700 p-4 flex items-center gap-4 bg-white dark:bg-gray-800 hover:shadow-sm transition-shadow">
          ...
          <div className="box-info">
            ...
            <div className="box-label text-sm text-gray-600/80 dark:text-gray-400">Awarded</div>
          </div>
        </div>
        ...
        <div className="box-total-scholarship rounded-xl border dark:border-gray-700 p-4 flex items-center gap-4 bg-white dark:bg-gray-800 hover:shadow-sm transition-shadow">
          ...
          <div className="box-info">
            ...
            <div className="box-label text-sm text-gray-600/80 dark:text-gray-400">Saved</div>
          </div>
        </div>
      </div>
    </div>
...
export const ScholarshipStatsWithProgress: React.FC<ScholarshipStatsProps> = ({
  ...
  const shortlistedPercentage = calculatePercentage(shortlisted, totalApplications);
...
export const ScholarshipStatsForDetail: React.FC<{ scholarship: ScholarshipData }> = ({ scholarship }) => {
  return (
