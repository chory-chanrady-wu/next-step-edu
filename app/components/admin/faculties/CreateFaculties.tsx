...
export default function AdminFacultiesPage() {
  ...
  const handleSelectFaculty = (id: string) => {
    if (selectedFaculties.includes(id)) {
      setSelectedFaculties(
        selectedFaculties.filter((facultyId) => facultyId !== id),
      );
    } else {
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-purple-600">
                  {faculties
                    .reduce((sum, f) => sum + (f.total_students || 0), 0)
                    .toLocaleString()}
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">
                    {selectedFaculties.length} faculty
                    {selectedFaculties.length !== 1 ? "ies" : ""} selected
                  </span>
                </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <span className="text-gray-600">
                  ...
                  {Math.min(endIndex, filteredFaculties.length)} of{" "}
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium">
                              {faculty.total_students?.toLocaleString() || "0"}
                            </span>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
        ...
        {filteredFaculties.length > 0 && (
          <div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="text-sm text-gray-700">
              Showing {startIndex + 1} to{" "}
              {Math.min(endIndex, filteredFaculties.length)} of{" "}
              {filteredFaculties.length} results
            </div>
            <div className="flex items-center gap-2">
              <button
          ...
          <div className="bg-white rounded-2xl max-w-md w-full">
            <div className="p-6">
              ...
              <p className="text-gray-600 text-center mb-6">
                ...
                <span className="font-semibold">{deletingFaculty.name}</span>?
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-md w-full">
            <div className="p-6">
              ...
              <p className="text-gray-600 text-center mb-6">
                Upload a CSV file with faculty data. Download the template file
