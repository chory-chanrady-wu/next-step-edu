...
const UserForm = ({ user, onClose }: UserFormProps) => {
    ...
    const [imagePreview, setImagePreview] = useState<string | null>(user.imageUrl || user.image || null);
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm transition-all duration-300">
            ...
            >
                ...
                <div className="px-8 py-6 border-b border-gray-50 flex items-center justify-between">
                    <div>
                        <h2 className="text-xl font-bold text-gray-900 font-outfit">Edit Profile</h2>
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-8">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="relative group">
                            <div className="w-24 h-24 rounded-2xl bg-gray-50 border border-gray-200 flex items-center justify-center overflow-hidden transition-all shadow-sm">
                                {imagePreview ? (
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1 leading-relaxed">
                                Upload a high-resolution image.<br />Supports JPG, PNG or WebP.
                            </p>
                        </div>
                    </div>
