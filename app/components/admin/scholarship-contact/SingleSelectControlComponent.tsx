...
import { ScholarshipContactCreateInput } from "@/lib/schema/scholarship-contact";

interface SingleSelectProps {
  control: Control<ScholarshipContactCreateInput>;
  name: Path<ScholarshipContactCreateInput>;
  id?: string;
