    ...
    <div className="min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage and view scholarship details
          </p>
        </div>
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="grid rounded w-full grid-cols-3 lg:w-auto lg:inline-flex">
          ...
          <TabsTrigger value="applications" className="rounded">
            Applications
          </TabsTrigger>
          <TabsTrigger value="analytics" className="rounded">
            Analytics
          </TabsTrigger>
        </TabsList>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="font-medium">
                    {getAwardTypeLabel(scholarship.awardType)}
                  </p>
                </div>
                <div className="space-y-1">
                  <p className="text-sm text-muted-foreground flex items-center gap-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant={
                        daysUntilDeadline < 30 ? "destructive" : "secondary"
                      }
                    >
                      {daysUntilDeadline > 0
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p className="font-medium">
                      {formatDate(scholarship.lastUpdated)}
                    </p>
                  </div>
                  <div className="flex flex-col items-center">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">10/29/2024</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">
                        Time until deadline
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {formatDistanceToNow(
                          new Date(scholarship.lastUpdated),
                          { addSuffix: true },
                        )}
                      </span>
                    </div>
